...
export const EngineSelector: React.FC<EngineSelectorProps> = ({       
  ...
  const selectedEngineData = engines.find(engine => engine.id === selectedEngine);      
            ...
            {engines.map((engine) => {    
              ...
              return (    
                <DropdownMenu.Item    
                  ...
                  className="px-3 py-2 hover:bg-gray-100 cursor-pointer rounded outline-none flex items-center gap-2"    
                >    
                  <input    
                    type="checkbox"    
                    checked={isChecked}    
          ...
          <TooltipTrigger asChild>      
            ...
            >      
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">      
                <path d={  
                  "M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416 " +  
                  ...
                  "1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.30.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 " +  
